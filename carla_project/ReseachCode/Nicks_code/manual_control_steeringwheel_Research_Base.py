...
class TrialManager:
    ...
    def get_daily_csv_file_path(self):
        ...
        return os.path.join('data', f'runs_data_{date_str}.csv')
    ...
    def load_user_names(self):
        ...
        memory_file = os.path.join('data', 'memory', 'user_names.json')
    ...
    def get_totals_csv_file_path(self):
        date_str = datetime.datetime.now().strftime('%Y-%m-%d')
        return os.path.join('data', f'totals_data_{date_str}.csv')
