## Code with zone data csv but only total time and average speed works not numbers of violation.
...
class TrialManager:
    ...
    def get_daily_csv_file_path(self):
        ...
        date_str = datetime.datetime.now().strftime('%Y-%m-%d')
        return os.path.join(self.data_dir, f'interval_data_{date_str}.csv')
