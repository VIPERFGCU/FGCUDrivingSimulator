...
def update_player_position(player, screen, font, current_zone, zones):
    # Get player coordinates
    transform = player.get_transform()
    location = transform.location

    # Update the current zone based on the player's position
    current_zone = check_user_position(location.x, location.y, screen, font, current_zone, zones)

    # Render the current zone message
    display_current_zone(screen, font, current_zone)

    return current_zone  # Return the updated zone
...
def game_loop(args):
    ...
    try:
        ...
        while True:
            ...
            current_zone = update_player_position(world.player, display, font, current_zone, zones)
